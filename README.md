...
*   **メニュー出力**:
    *   生成されたメニューをPDF/CSV形式でダウンロードできます。
...
# VSCode Open Tabs
app/api/chromadb-alternative.md
components/footer.tsx
components/menu-creation-form.tsx
next.config.mjs
middleware.ts
lib/blob-storage.ts
.env.example
.env.development.local
components/result-content.tsx
app/api/get-menu/route.ts
components/menu-history-list.tsx
app/api/get-menu-history/route.ts
app/api/generate-menu/route.ts
lib/kv-storage.ts
components/training-menu-result.tsx
memory_bank/definition.md
README.md

# Current Time
2025/4/3 午後9:11:00 (Asia/Tokyo, UTC+9:00)
