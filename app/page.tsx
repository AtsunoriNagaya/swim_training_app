...
import { ArrowRight, Calendar, FileText, Upload, Cpu, Database, Download, HelpCircle } from "lucide-react"
  ...
  return (
    <div>
      ...
      <section className="relative overflow-hidden py-16 md:py-24">
        <div className="absolute inset-0 bg-gradient-to-br from-primary/10 via-background to-secondary/10 dark:from-primary/5 dark:to-secondary/5"></div>
